...
public:
    ...
    projectile();
    projectile(std::string bullet_name, double x, double y,int speed, double angle, int init_explosion_timer, int init_explosion_radius,int init_damage, class gamefield* init_gamefield = nullptr,class character* character_pointer = nullptr);
